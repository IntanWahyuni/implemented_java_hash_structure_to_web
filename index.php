...
<body>
	...
	<nav class="navbar navbar-expand-lg " style="background-color: #cc66ff">
	  <a style="color: black" class="navbar-brand font-weight-bold" href="#"><i class="fas fa-edit"></i> DATA EDITOR</a>
	  ...
	  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	    <ul class="navbar-nav ml-auto">
	      <li class="nav-item active">
	        <a style="color: black" class="nav-link" href="cari.php">PENCARIAN EDITOR</a>
	      </li>
	      <li class="nav-item active">
	        <a style="color: black" class="nav-link" href="tampil.php">TAMPILKAN EDITOR</a>
	      </li>
	      <li class="nav-item active">
	        <a style="color: black"  class="nav-link" href="about.php">ABOUT ME</a>
	      </li>
	    </ul>
	  </div>
	</nav>
